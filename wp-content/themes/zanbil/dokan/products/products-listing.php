                                ...
                                while ($product_query->have_posts()) {
                                    ...
                                    <td data-title="<?php _e( 'Price', 'dokan-lite' ); ?>">
                                        ...
                                        if ( $product->get_price_html() ) { 
											...
											<del><span class="woocommerce-Price-amount amount"><?php echo wc_price($product->get_regular_price()); ?></span></del>
											<ins><span class="woocommerce-Price-amount amount"><?php echo wc_price($product->get_sale_price()); ?></span></ins>
										<?php
											} else {
