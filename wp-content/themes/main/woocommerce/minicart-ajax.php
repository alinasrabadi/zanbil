...
global $woocommerce; ?>
<div class="top-form top-form-minicart topbar-minicart pull-right">
	<div class="cart-btn pull-right">
	    <i class="cart-icon"></i>سبد خرید <?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';?>
	</div>
