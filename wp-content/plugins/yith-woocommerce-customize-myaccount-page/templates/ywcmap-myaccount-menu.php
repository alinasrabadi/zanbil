...
<div class="user-profile">
    ...
    <div class="user-info">
        ...
        <?php if( isset( $current_user ) && $current_user->ID != 0 ) : ?>
            <span class="logout"><a href="<?php echo esc_url( $logout_url ) ?>" style="border-left: 1px solid #ddd;">خروج</a></span>
			<span class="logout"><a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account' ) )?>">تغییر رمز</a></span>
        <?php endif; ?>
    </div>
